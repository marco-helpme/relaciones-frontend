...
function handlePostVideo(raw_data, videoList, callback) {
    ...
    var videoData = {
        domain: parseImageDomain(data['video_name'], videoDomain1, videoDomain2),
...
function posterLink(videoData) {
    var domain = videoData.type !== 1 ? parseImageDomain(videoData.coverName, videoDomain1, videoDomain2) : imagePreviewDomain;
